...
public class ProvinceController extends BaseController {
	...
	/**
	 * @Title: findProvince
	 * @Description: 分页查询Province	 * @param nextPage
	 * @param pageSize
	...
	public XaResult<List<Province>> findProvince(
		...
		return provinceService.findProvinceNEStatus(status);
	}
	
	/**
	 * @Title: findProvinceNEStatusPage
	 * @Description: 分页查询Province	 * @param nextPage
	 * @param pageSize
	 * @param status		//默认查询非删除3的数据,具体类型参照XaConstant.Status
	 * @param sortDate
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findProvinceNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Province>> findProvinceNEStatusPage(
		...
		return provinceService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findProvinceEQStatusPage
	 * @Description: (预留)分页查询Province	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findProvinceEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Province>> findProvinceEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return provinceService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findProvinceById",method=RequestMethod.POST)
	public XaResult<Province> findProvinceById(
		@RequestParam Long modelId
	) throws BusinessException{
		return provinceService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Province> saveProvince(
		Province model
	) throws BusinessException{
		return provinceService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateProvinceByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateProvinceByIds",method=RequestMethod.POST)
	public XaResult<Province> operateProvinceByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return provinceService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/province";
