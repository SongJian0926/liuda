...
/**
 * @Title: EventMsgController.java
 * @Package com.web.webstart.business.controller
 * @Description: 俱乐部留言表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/eventMsg")
public class EventMsgController extends BaseController {
	...
	/**
	 * @Title: findEventMsgNEStatusPage
	 * @Description: 分页查询EventMsg	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findEventMsgNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<EventMsg>> findEventMsgNEStatusPage(
		...
		return eventMsgService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findEventMsgEQStatusPage
	 * @Description: (预留)分页查询EventMsg	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findEventMsgEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<EventMsg>> findEventMsgEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return eventMsgService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<EventMsg> findEventMsgById(
	...
	public XaResult<EventMsg> saveEventMsg(
		EventMsg model
	) throws BusinessException{
		return eventMsgService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateEventMsgByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateEventMsgByIds",method=RequestMethod.POST)
	public XaResult<EventMsg> operateEventMsgByIds(
