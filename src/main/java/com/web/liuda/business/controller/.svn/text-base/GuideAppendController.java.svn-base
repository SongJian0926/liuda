...
/**
 * @Title: GuideAppendController.java
 * @Package com.web.webstart.business.controller
 * @Description: 攻略追加表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/guideAppend")
public class GuideAppendController extends BaseController {

	@Autowired
	private GuideAppendService guideAppendService;
	
	/**
	 * @Title: findGuideAppendNEStatusPage
	 * @Description: 分页查询GuideAppend	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideAppendNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideAppend>> findGuideAppendNEStatusPage(
		...
		return guideAppendService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideAppendEQStatusPage
	 * @Description: (预留)分页查询GuideAppend	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideAppendEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideAppend>> findGuideAppendEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return guideAppendService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideAppendById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findGuideAppendById",method=RequestMethod.POST)
	public XaResult<GuideAppend> findGuideAppendById(
		@RequestParam Long modelId
	) throws BusinessException{
		return guideAppendService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveGuideAppend",method=RequestMethod.POST)
	public XaResult<GuideAppend> saveGuideAppend(
		GuideAppend model
	) throws BusinessException{
		return guideAppendService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateGuideAppendByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateGuideAppendByIds",method=RequestMethod.POST)
	public XaResult<GuideAppend> operateGuideAppendByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return guideAppendService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/guideAppend";
