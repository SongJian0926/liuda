...
/**
 * @Title: PrizeResultController.java
 * @Package com.web.webstart.business.controller
 * @Description: 二次抽奖结果控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/prizeResult")
public class PrizeResultController extends BaseController {

	@Autowired
	private PrizeResultService prizeResultService;
	
	/**
	 * @Title: findPrizeResultNEStatusPage
	 * @Description: 分页查询PrizeResult	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findPrizeResultNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<PrizeResult>> findPrizeResultNEStatusPage(
		...
		return prizeResultService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findPrizeResultEQStatusPage
	 * @Description: (预留)分页查询PrizeResult	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findPrizeResultEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<PrizeResult>> findPrizeResultEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return prizeResultService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findPrizeResultById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findPrizeResultById",method=RequestMethod.POST)
	public XaResult<PrizeResult> findPrizeResultById(
		@RequestParam Long modelId
	) throws BusinessException{
		return prizeResultService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="savePrizeResult",method=RequestMethod.POST)
	public XaResult<PrizeResult> savePrizeResult(
		PrizeResult model
	) throws BusinessException{
		return prizeResultService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperatePrizeResultByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operatePrizeResultByIds",method=RequestMethod.POST)
	public XaResult<PrizeResult> operatePrizeResultByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return prizeResultService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/prizeResult";
