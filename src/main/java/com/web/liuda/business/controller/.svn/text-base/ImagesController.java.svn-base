...
public class ImagesController extends BaseController {
	...
	/**
	 * @Title: findImagesNEStatusPage
	 * @Description: 分页查询Images	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findImagesNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Images>> findImagesNEStatusPage(
		...
		return imagesService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findImagesEQStatusPage
	 * @Description: (预留)分页查询Images	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findImagesEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Images>> findImagesEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return imagesService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findImagesById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findImagesById",method=RequestMethod.POST)
	public XaResult<Images> findImagesById(
		@RequestParam Long modelId
	) throws BusinessException{
		return imagesService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Images> saveImages(
		Images model
	) throws BusinessException{
		return imagesService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateImagesByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateImagesByIds",method=RequestMethod.POST)
	public XaResult<Images> operateImagesByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return imagesService.multiOperate(modelIds,status);
	}
