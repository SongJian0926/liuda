...
public class AddressController extends BaseController {
	...
	/**
	 * @Title: findAddressNEStatusPage
	 * @Description: 分页查询Address	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findAddressNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Address>> findAddressNEStatusPage(
		...
		return addressService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	/**
	 * @Title: findAddressNEStatusPage
	 * @Description: 分页查询Address	 * @param nextPage
	...
	public XaResult<Page<AddressVo>> findAddressList(
		...
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return addressService.findAddressList(nextPage, pageSize, filterParams);
	}
	/**
	 * @Title: findAddressEQStatusPage
	 * @Description: (预留)分页查询Address	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findAddressEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Address>> findAddressEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return addressService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<AddressVo> findAddressById(
		...
		return addressService.findAddressDetail(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Address> saveAddress(
		Address model
	) throws BusinessException{
		return addressService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateAddressByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateAddressByIds",method=RequestMethod.POST)
	public XaResult<Address> operateAddressByIds(
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/address";
