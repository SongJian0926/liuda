...
/**
 * @Title: GuideCommentController.java
 * @Package com.web.webstart.business.controller
 * @Description: 攻略评论表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/guideComment")
public class GuideCommentController extends BaseController {

	@Autowired
	private GuideCommentService guideCommentService;
	
	/**
	 * @Title: findGuideCommentNEStatusPage
	 * @Description: 分页查询GuideComment	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideCommentNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideComment>> findGuideCommentNEStatusPage(
		...
		return guideCommentService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideCommentEQStatusPage
	 * @Description: (预留)分页查询GuideComment	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideCommentEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideComment>> findGuideCommentEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return guideCommentService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideCommentById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findGuideCommentById",method=RequestMethod.POST)
	public XaResult<GuideComment> findGuideCommentById(
		@RequestParam Long modelId
	) throws BusinessException{
		return guideCommentService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<GuideComment> saveGuideComment(
		GuideComment model
	) throws BusinessException{
		return guideCommentService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateGuideCommentByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateGuideCommentByIds",method=RequestMethod.POST)
	public XaResult<GuideComment> operateGuideCommentByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return guideCommentService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/guideComment";
