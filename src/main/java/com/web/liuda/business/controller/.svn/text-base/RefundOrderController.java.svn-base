...
/**
 * @Title: RefundOrderController.java
 * @Package com.web.webstart.business.controller
 * @Description: 订单退款表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/refundOrder")
public class RefundOrderController extends BaseController {
	...
	/**
	 * @Title: findRefundOrderNEStatusPage
	 * @Description: 分页查询RefundOrder	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findRefundOrderNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<RefundOrder>> findRefundOrderNEStatusPage(
		...
		return refundOrderService.findListNEStatusByFilter(status, filterParams, pageable);
	}

	/**
	 * @Title: findRefundOrderVoNEStatusPage
	 * @Description: 分页查询RefundOrder	 * @param nextPage
	 * @param pageSize
	 * @param status		//默认查询非删除3的数据,具体类型参照XaConstant.Status
	 * @param sortDate
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findRefundOrderVoNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<RefundOrderVo>> findRefundOrderVoNEStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		@RequestParam(defaultValue = "3") Integer status,
		@RequestParam(defaultValue = "[{property:'createTime',direction:'DESC'}]") String sortData,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
//		XaResult<Page<RefundOrder>> xr = refundOrderService.findListNEStatusByFilter(status, filterParams, pageable);
...
//		}
//		return xrvo;
		return refundOrderService.findRefundOrderVoNEStatusPage(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findRefundOrderEQStatusPage
	 * @Description: (预留)分页查询RefundOrder	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findRefundOrderEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<RefundOrder>> findRefundOrderEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return refundOrderService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<RefundOrder> findRefundOrderById(
	...
	public XaResult<RefundOrder> saveRefundOrder(
		RefundOrder model
	) throws BusinessException{
		return refundOrderService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateRefundOrderByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateRefundOrderByIds",method=RequestMethod.POST)
	public XaResult<RefundOrder> operateRefundOrderByIds(
	...
	/**
	 * @Title: applyRefundOrder
	 * @Description:后台俱乐部的审批
	 * @param matchIds 俱乐部ID列表,以逗号分隔
	 * author:flora  2016-05-20
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="applyRefundOrder",method=RequestMethod.POST)
	public XaResult<String> applyRefundOrder(
		HttpServletRequest request,
		@RequestParam String refundIds,
		@RequestParam Integer status
	) throws BusinessException{
		String rootpath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort();
		return refundOrderService.applyRefundOrder(rootpath, refundIds,status);
	}
