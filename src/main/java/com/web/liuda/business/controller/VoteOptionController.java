...
/**
 * @Title: VoteOptionController.java
 * @Package com.web.webstart.business.controller
 * @Description: 投票选项表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/voteOption")
public class VoteOptionController extends BaseController {
	...
	/**
	 * @Title: findVoteOptionNEStatusPage
	 * @Description: 分页查询VoteOption	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findVoteOptionNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<VoteOption>> findVoteOptionNEStatusPage(
		...
		return voteOptionService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findVoteOptionEQStatusPage
	 * @Description: (预留)分页查询VoteOption	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findVoteOptionEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<VoteOption>> findVoteOptionEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return voteOptionService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findVoteOptionById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findVoteOptionById",method=RequestMethod.POST)
	public XaResult<VoteOption> findVoteOptionById(
		@RequestParam Long modelId
	) throws BusinessException{
		return voteOptionService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<VoteOption> saveVoteOption(
		VoteOption model
	) throws BusinessException{
		return voteOptionService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateVoteOptionByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateVoteOptionByIds",method=RequestMethod.POST)
	public XaResult<VoteOption> operateVoteOptionByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return voteOptionService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/voteOption";
