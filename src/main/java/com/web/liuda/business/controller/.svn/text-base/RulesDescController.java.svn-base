...
/**
 * @Title: RulesDescController.java
 * @Package com.web.webstart.business.controller
 * @Description: 条款注意事项表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/rulesDesc")
public class RulesDescController extends BaseController {

	@Autowired
	private RulesDescService rulesDescService;
	
	/**
	 * @Title: findRulesDescNEStatusPage
	 * @Description: 分页查询RulesDesc	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findRulesDescNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<RulesDesc>> findRulesDescNEStatusPage(
		...
		return rulesDescService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findRulesDescEQStatusPage
	 * @Description: (预留)分页查询RulesDesc	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findRulesDescEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<RulesDesc>> findRulesDescEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return rulesDescService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findRulesDescById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findRulesDescById",method=RequestMethod.POST)
	public XaResult<RulesDesc> findRulesDescById(
		@RequestParam Long modelId
	) throws BusinessException{
		return rulesDescService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveRulesDesc",method=RequestMethod.POST)
	public XaResult<RulesDesc> saveRulesDesc(
		RulesDesc model
	) throws BusinessException{
		return rulesDescService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateRulesDescByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateRulesDescByIds",method=RequestMethod.POST)
	public XaResult<RulesDesc> operateRulesDescByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return rulesDescService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/rulesDesc";
