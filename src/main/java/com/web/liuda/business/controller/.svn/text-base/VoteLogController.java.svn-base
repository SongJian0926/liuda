...
public class VoteLogController extends BaseController {
	...
	/**
	 * @Title: findVoteLogNEStatusPage
	 * @Description: 分页查询VoteLog	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findVoteLogNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<VoteLog>> findVoteLogNEStatusPage(
		...
		return voteLogService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findVoteLogEQStatusPage
	 * @Description: (预留)分页查询VoteLog	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findVoteLogEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<VoteLog>> findVoteLogEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return voteLogService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findVoteLogById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findVoteLogById",method=RequestMethod.POST)
	public XaResult<VoteLog> findVoteLogById(
		@RequestParam Long modelId
	) throws BusinessException{
		return voteLogService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveVoteLog",method=RequestMethod.POST)
	public XaResult<VoteLog> saveVoteLog(
		VoteLog model
	) throws BusinessException{
		return voteLogService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateVoteLogByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateVoteLogByIds",method=RequestMethod.POST)
	public XaResult<VoteLog> operateVoteLogByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return voteLogService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/voteLog";
