...
public class WithdrawController extends BaseController {
	...
	/**
	 * @Title: findWithdrawNEStatusPage
	 * @Description: 分页查询Withdraw	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findWithdrawNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Withdraw>> findWithdrawNEStatusPage(
		...
		return withdrawService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findWithdrawEQStatusPage
	 * @Description: (预留)分页查询Withdraw	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findWithdrawEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Withdraw>> findWithdrawEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return withdrawService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findWithdrawById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findWithdrawById",method=RequestMethod.POST)
	public XaResult<Withdraw> findWithdrawById(
		@RequestParam Long modelId
	) throws BusinessException{
		return withdrawService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Withdraw> saveWithdraw(
		Withdraw model
	) throws BusinessException{
		return withdrawService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateWithdrawByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateWithdrawByIds",method=RequestMethod.POST)
	public XaResult<Withdraw> operateWithdrawByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return withdrawService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/withdraw";
