...
/**
 * @Title: StandardController.java
 * @Package com.web.webstart.business.controller
 * @Description: 商品规格属性控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/standard")
public class StandardController extends BaseController {
	...
	/**
	 * @Title: findStandardNEStatusPage
	 * @Description: 分页查询Standard	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findStandardNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Standard>> findStandardNEStatusPage(
		...
		return standardService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findStandardEQStatusPage
	 * @Description: (预留)分页查询Standard	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findStandardEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Standard>> findStandardEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return standardService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findStandardById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findStandardById",method=RequestMethod.POST)
	public XaResult<Standard> findStandardById(
		@RequestParam Long modelId
	) throws BusinessException{
		return standardService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Standard> saveStandard(
		Standard model
	) throws BusinessException{
		return standardService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateStandardByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateStandardByIds",method=RequestMethod.POST)
	public XaResult<Standard> operateStandardByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return standardService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/standard";
