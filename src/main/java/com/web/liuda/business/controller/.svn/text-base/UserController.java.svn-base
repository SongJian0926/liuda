...
public class UserController extends BaseController {
	...
	/**
	 * @Title: findUserNEStatusPage
	 * @Description: 分页查询User	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findUserNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<User>> findUserNEStatusPage(
		...
		return userService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findUserEQStatusPage
	 * @Description: (预留)分页查询User	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findUserEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<User>> findUserEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return userService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<User> findUserById(
		@RequestParam Long modelId
	) throws BusinessException{
		return userService.findOne(modelId);
	}
	/**
	 * @Title: findUserList
	 * @Description: 
	...
	public XaResult<List<User>> findUserList(
	) throws BusinessException{
		return userService.findUserListStatusNot(null);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateUserByIds",method=RequestMethod.POST)
	public XaResult<User> operateUserByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return userService.multiOperate(modelIds,status);
	}
	/**
	 * 同意申请为大咖
	 * author:changlu
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="checkBigShot",method=RequestMethod.POST)
	public XaResult<User> checkBigShot(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(value="bigShot") Integer bigShot
	) throws BusinessException{
		return userService.checkBigShot(modelIds,bigShot);
	}
	/**
	 * @Title: upload
	 * @Description: 图片上传
