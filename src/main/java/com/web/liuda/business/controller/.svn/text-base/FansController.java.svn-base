...
public class FansController extends BaseController {
	...
	/**
	 * @Title: findFansNEStatusPage
	 * @Description: 分页查询Fans	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findFansNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Fans>> findFansNEStatusPage(
		...
		return fansService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findFansEQStatusPage
	 * @Description: (预留)分页查询Fans	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findFansEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Fans>> findFansEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return fansService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findFansById",method=RequestMethod.POST)
	public XaResult<Fans> findFansById(
		@RequestParam Long modelId
	) throws BusinessException{
		return fansService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Fans> saveFans(
		Fans model
	) throws BusinessException{
		return fansService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateFansByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateFansByIds",method=RequestMethod.POST)
	public XaResult<Fans> operateFansByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return fansService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/fans";
