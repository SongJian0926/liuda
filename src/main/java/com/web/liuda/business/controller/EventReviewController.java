...
/**
 * @Title: EventReviewController.java
 * @Package com.web.webstart.business.controller
 * @Description: 俱乐部活动回顾表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/eventReview")
public class EventReviewController extends BaseController {

	@Autowired
	private EventReviewService eventReviewService;
	
	/**
	 * @Title: findEventReviewNEStatusPage
	 * @Description: 分页查询EventReview	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findEventReviewNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<EventReview>> findEventReviewNEStatusPage(
		...
		return eventReviewService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findEventReviewEQStatusPage
	 * @Description: (预留)分页查询EventReview	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findEventReviewEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<EventReview>> findEventReviewEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return eventReviewService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<EventReview> findEventReviewById(
	...
	public XaResult<EventReview> saveEventReview(
		EventReview model
	) throws BusinessException{
		return eventReviewService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateEventReviewByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateEventReviewByIds",method=RequestMethod.POST)
	public XaResult<EventReview> operateEventReviewByIds(
