...
/**
 * @Title: ShopRecordController.java
...
public class ShopRecordController extends BaseController {
	...
	/**
	 * @Title: findShopRecordNEStatusPage
	 * @Description: 分页查询ShopRecord	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findShopRecordNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<ShopRecord>> findShopRecordNEStatusPage(
		...
		return shopRecordService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findShopRecordEQStatusPage
	 * @Description: (预留)分页查询ShopRecord	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findShopRecordEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<ShopRecord>> findShopRecordEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return shopRecordService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findShopRecordById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findShopRecordById",method=RequestMethod.POST)
	public XaResult<ShopRecord> findShopRecordById(
		@RequestParam Long modelId
	) throws BusinessException{
		return shopRecordService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveShopRecord",method=RequestMethod.POST)
	public XaResult<ShopRecord> saveShopRecord(
		ShopRecord model
	) throws BusinessException{
		return shopRecordService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateShopRecordByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateShopRecordByIds",method=RequestMethod.POST)
	public XaResult<ShopRecord> operateShopRecordByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return shopRecordService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/shopRecord";
