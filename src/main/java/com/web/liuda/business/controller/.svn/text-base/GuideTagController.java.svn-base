...
/**
 * @Title: GuideTagController.java
 * @Package com.web.webstart.business.controller
 * @Description: 攻略标签表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/guideTag")
public class GuideTagController extends BaseController {

	@Autowired
	private GuideTagService guideTagService;
	
	/**
	 * @Title: findGuideTagNEStatusPage
	 * @Description: 分页查询GuideTag	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideTagNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideTag>> findGuideTagNEStatusPage(
		...
		return guideTagService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideTagEQStatusPage
	 * @Description: (预留)分页查询GuideTag	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuideTagEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuideTag>> findGuideTagEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return guideTagService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuideTagById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findGuideTagById",method=RequestMethod.POST)
	public XaResult<GuideTag> findGuideTagById(
		@RequestParam Long modelId
	) throws BusinessException{
		return guideTagService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveGuideTag",method=RequestMethod.POST)
	public XaResult<GuideTag> saveGuideTag(
		GuideTag model
	) throws BusinessException{
		return guideTagService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateGuideTagByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateGuideTagByIds",method=RequestMethod.POST)
	public XaResult<GuideTag> operateGuideTagByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return guideTagService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/guideTag";
