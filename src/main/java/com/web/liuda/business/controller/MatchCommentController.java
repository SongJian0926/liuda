...
/**
 * @Title: MatchCommentController.java
 ...
 */
@Controller
@RequestMapping("/cms/matchComment")
public class MatchCommentController extends BaseController {

	@Autowired
	private MatchCommentService matchCommentService;
	
	/**
	 * @Title: findMatchCommentNEStatusPage
	 * @Description: 分页查询MatchComment	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findMatchCommentNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<MatchComment>> findMatchCommentNEStatusPage(
		...
		return matchCommentService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findMatchCommentEQStatusPage
	 * @Description: (预留)分页查询MatchComment	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findMatchCommentEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<MatchComment>> findMatchCommentEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return matchCommentService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findMatchCommentById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findMatchCommentById",method=RequestMethod.POST)
	public XaResult<MatchComment> findMatchCommentById(
		@RequestParam Long modelId
	) throws BusinessException{
		return matchCommentService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<MatchComment> saveMatchComment(
		MatchComment model
	) throws BusinessException{
		return matchCommentService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateMatchCommentByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateMatchCommentByIds",method=RequestMethod.POST)
	public XaResult<MatchComment> operateMatchCommentByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return matchCommentService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/matchComment";
