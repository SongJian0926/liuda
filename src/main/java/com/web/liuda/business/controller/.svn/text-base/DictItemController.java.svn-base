...
public class DictItemController extends BaseController {
	...
	/**
	 * @Title: findDictItemNEStatusPage
	 * author：changlu
	 * time:2016-5-6 11:32:00
	 * @Description: 分页查询字典选项列表
	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictItemNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<DictVo>> findDictItemNEStatusPage(
		...
		return dictItemService.findList(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findDictItemEQStatusPage
	 * @Description: (预留)分页查询DictItem	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictItemEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<DictItem>> findDictItemEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return dictItemService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findDictItemByType
	 * author：changlu
	 * time:2016-5-6 11:32:00
	 * @Description: 分页查询字典选项列表
	 * @param nextPage
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictItemByType",method=RequestMethod.POST)
	public XaResult<List<DictItem>> findDictItemByType(
		@RequestParam(defaultValue = "3") Integer status,
		@RequestParam(defaultValue = "0") Integer type,
		@RequestParam(defaultValue = "[{property:'createTime',direction:'DESC'}]") String sortData,
		@RequestParam(defaultValue = "{}") String jsonFilter
	) throws BusinessException{
		return dictItemService.findListByType(status, type);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictItemById",method=RequestMethod.POST)
	public XaResult<DictItem> findDictItemById(
		@RequestParam Long modelId
	) throws BusinessException{
		return dictItemService.findOne(modelId);
	}
	...
	public XaResult<DictItem> saveDictItem(
		DictItem model
	) throws BusinessException{
		return dictItemService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateDictItemByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateDictItemByIds",method=RequestMethod.POST)
	public XaResult<DictItem> operateDictItemByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return dictItemService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/dictItem";
