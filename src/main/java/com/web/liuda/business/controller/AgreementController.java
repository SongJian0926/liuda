...
public class AgreementController extends BaseController {
	...
	/**
	 * @Title: findAgreementNEStatusPage
	 * @Description: 分页查询Agreement	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findAgreementNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Agreement>> findAgreementNEStatusPage(
		...
		return agreementService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findAgreementEQStatusPage
	 * @Description: (预留)分页查询Agreement	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findAgreementEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Agreement>> findAgreementEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return agreementService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findAgreementById",method=RequestMethod.POST)
	public XaResult<Agreement> findAgreementById(
		@RequestParam Long modelId
	) throws BusinessException{
		return agreementService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Agreement> saveAgreement(
		Agreement model
	) throws BusinessException{
		return agreementService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateAgreementByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateAgreementByIds",method=RequestMethod.POST)
	public XaResult<Agreement> operateAgreementByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return agreementService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/agreement";
