...
public class ClubController extends BaseController {
	...
	/**
	 * @Title: findClubNEStatusPage
	 * @Description: 分页查询Club	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findClubNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Club>> findClubNEStatusPage(
		...
		return clubService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findClubEQStatusPage
	 * @Description: (预留)分页查询Club	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findClubEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Club>> findClubEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return clubService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<Club> findClubById(
		@RequestParam Long modelId
	) throws BusinessException{
		return clubService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<Club> saveClub(
			@RequestParam Long id,
			@RequestParam String areaName,
			Club model
	) throws BusinessException{
		model.setAreaCode(areaName);
		return clubService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateClubByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateClubByIds",method=RequestMethod.POST)
	public XaResult<Club> operateClubByIds(
	...
	public XaResult<Club> applyClub(
		HttpServletRequest request,
		@RequestParam String clubIds,
		@RequestParam Integer status
	) throws BusinessException{
		return clubService.applyClub(clubIds,status);
	}

	/**
	 * @Title: recommendClub
	 * @Description:后台俱乐部的推荐
	 * @param matchIds 俱乐部ID列表,以逗号分隔
	 * author:flora  2016-05-20
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="recommendClub",method=RequestMethod.POST)
	public XaResult<Club> recommendClub(
		HttpServletRequest request,
		@RequestParam String clubIds,
		@RequestParam Integer status
	) throws BusinessException{
		return clubService.recommendClub(clubIds,status);
	}
