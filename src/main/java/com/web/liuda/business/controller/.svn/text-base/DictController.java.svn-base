...
public class DictController extends BaseController {
	...
	/**
	 * @Title: findDictNEStatusPage
	 * @Description: 分页查询Dict	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Dict>> findDictNEStatusPage(
		...
		return dictService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findDictEQStatusPage
	 * @Description: (预留)分页查询Dict	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDictEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<Dict>> findDictEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return dictService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<Dict> findDictById(
	...
	public XaResult<Dict> saveDict(
		Dict model
	) throws BusinessException{
		return dictService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateDictByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateDictByIds",method=RequestMethod.POST)
	public XaResult<Dict> operateDictByIds(
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="checkDict",method=RequestMethod.POST)
	public String findDictName(@RequestParam String dictName,
			@RequestParam Long id)
			throws BusinessException {
		return dictService.findDictName(dictName,id);
	}
}
