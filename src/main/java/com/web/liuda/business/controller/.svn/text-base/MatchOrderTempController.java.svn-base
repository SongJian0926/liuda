...
/**
 * @Title: MatchOrderTempController.java
 * @Package com.web.webstart.business.controller
 * @Description: 赛事报名临时表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/matchOrderTemp")
public class MatchOrderTempController extends BaseController {

	@Autowired
	private MatchOrderTempService matchOrderTempService;
	
	/**
	 * @Title: findMatchOrderTempNEStatusPage
	 * @Description: 分页查询MatchOrderTemp	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findMatchOrderTempNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<MatchOrderTemp>> findMatchOrderTempNEStatusPage(
		...
		return matchOrderTempService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findMatchOrderTempEQStatusPage
	 * @Description: (预留)分页查询MatchOrderTemp	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findMatchOrderTempEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<MatchOrderTemp>> findMatchOrderTempEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return matchOrderTempService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	...
	public XaResult<MatchOrderTemp> findMatchOrderTempById(
	...
	public XaResult<MatchOrderTemp> saveMatchOrderTemp(
		MatchOrderTemp model
	) throws BusinessException{
		return matchOrderTempService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateMatchOrderTempByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateMatchOrderTempByIds",method=RequestMethod.POST)
	public XaResult<MatchOrderTemp> operateMatchOrderTempByIds(
