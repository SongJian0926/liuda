...
/**
 * @Title: UserCardController.java
 * @Package com.web.webstart.business.controller
 * @Description: 用户银行卡控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/userCard")
public class UserCardController extends BaseController {
	...
	/**
	 * @Title: findUserCardNEStatusPage
	 * @Description: 分页查询UserCard	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findUserCardNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<UserCard>> findUserCardNEStatusPage(
		...
		return userCardService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findUserCardEQStatusPage
	 * @Description: (预留)分页查询UserCard	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findUserCardEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<UserCard>> findUserCardEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return userCardService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findUserCardById",method=RequestMethod.POST)
	public XaResult<UserCard> findUserCardById(
		@RequestParam Long modelId
	) throws BusinessException{
		return userCardService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	...
	public XaResult<UserCard> saveUserCard(
		UserCard model
	) throws BusinessException{
		return userCardService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateUserCardByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateUserCardByIds",method=RequestMethod.POST)
	public XaResult<UserCard> operateUserCardByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return userCardService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/userCard";
