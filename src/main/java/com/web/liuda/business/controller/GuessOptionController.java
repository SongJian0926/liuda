...
/**
 * @Title: GuessOptionController.java
 * @Package com.web.webstart.business.controller
 * @Description: 赛事选项表控制器
 * @author eason.zt
 * @date 2015年3月23日 下午1:00:00
 * @version V1.0
 */
@Controller
@RequestMapping("/cms/guessOption")
public class GuessOptionController extends BaseController {

	@Autowired
	private GuessOptionService guessOptionService;
	
	/**
	 * @Title: findGuessOptionNEStatusPage
	 * @Description: 分页查询GuessOption	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuessOptionNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuessOption>> findGuessOptionNEStatusPage(
		...
		return guessOptionService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuessOptionEQStatusPage
	 * @Description: (预留)分页查询GuessOption	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findGuessOptionEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<GuessOption>> findGuessOptionEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return guessOptionService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findGuessOptionById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findGuessOptionById",method=RequestMethod.POST)
	public XaResult<GuessOption> findGuessOptionById(
		@RequestParam Long modelId
	) throws BusinessException{
		return guessOptionService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveGuessOption",method=RequestMethod.POST)
	public XaResult<GuessOption> saveGuessOption(
		GuessOption model
	) throws BusinessException{
		return guessOptionService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateGuessOptionByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateGuessOptionByIds",method=RequestMethod.POST)
	public XaResult<GuessOption> operateGuessOptionByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return guessOptionService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/guessOption";
