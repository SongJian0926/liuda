...
public class ShopCarController extends BaseController {
	...
	/**
	 * @Title: findShopCarNEStatusPage
	 * @Description: 分页查询ShopCar	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findShopCarNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<ShopCar>> findShopCarNEStatusPage(
		...
		return shopCarService.findListNEStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findShopCarEQStatusPage
	 * @Description: (预留)分页查询ShopCar	 * @param nextPage
	 * @param pageSize
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findShopCarEQStatusPage",method=RequestMethod.POST)
	public XaResult<Page<ShopCar>> findShopCarEQStatusPage(
		@RequestParam(defaultValue = "0") Integer nextPage,
		@RequestParam(defaultValue = "10") Integer pageSize,
		...
		Pageable pageable = WebUitl.buildPageRequest(nextPage, pageSize, sortData);
		Map<String,Object> filterParams =  WebUitl.getParametersStartingWith(jsonFilter, "search_");
		return shopCarService.findListEQStatusByFilter(status, filterParams, pageable);
	}
	
	/**
	 * @Title: findShopCarById
	 * @Description: 根据ID查找单条实体
	 * @param modelId
	 * @return    
	 */
	@ResponseBody
	@RequestMapping(value="findShopCarById",method=RequestMethod.POST)
	public XaResult<ShopCar> findShopCarById(
		@RequestParam Long modelId
	) throws BusinessException{
		return shopCarService.findOne(modelId);
	}
	/**
	 * @Title: saveModel
	 * @Description: 保存实体数据
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="saveShopCar",method=RequestMethod.POST)
	public XaResult<ShopCar> saveShopCar(
		ShopCar model
	) throws BusinessException{
		return shopCarService.saveOrUpdate(model);
	}
	
	/**
	 * @Title: multiOperateShopCarByIds
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="operateShopCarByIds",method=RequestMethod.POST)
	public XaResult<ShopCar> operateShopCarByIds(
		HttpServletRequest request,
		@RequestParam String modelIds,
		@RequestParam(defaultValue = "3") Integer status
	) throws BusinessException{
		return shopCarService.multiOperate(modelIds,status);
	}
	...
	public XaResult<String> photoUpload(
		...
		String picturePath = "/upload/shopCar";
