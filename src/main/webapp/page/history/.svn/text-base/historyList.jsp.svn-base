...
<html>
	...
	var contentUrl = root + "cms/history/findHistoryNEStatusPage";
	var editUrl = 'historyEdit.jsp?id=';
	var operateUrl = root + 'cms/history/operateHistoryByIds';
	function getfilter(){
		var _jsonFilter = "{";
              ...
              <div class="col-xs-12">
                  <div class="box">
                      	...
                      	<div class="tabSelect" id="selectHeadId">
                      		<br>
           	            	<div class="form-group  col-md-3 search-form">
        						<label class="col-md-4 control-label controls" for="formGroupInputSmall">用户Id：</label>
       				 			<div class="col-md-8">
									<input type="text" placeholder="用户Id" class="form-control input-sm" id="search_userId" name="userId"/>
								</div>
      						</div>
			            	<div class="form-group  col-md-3 search-form">
			            	...
			            	<div class="form-group  col-md-3 search-form">
        						<label class="col-md-4 control-label controls" for="formGroupInputSmall">类型：</label>
       				 			<div class="col-md-8">
									<input type="text" placeholder="类型" class="form-control input-sm" id="search_type" name="type"/>
								</div>
      						</div>
                      ...
                      <div class="box-body table-responsive" style="clear:both;">
                          ...
                          <input type="button" value="锁定" id="lockSome" class="btn btn-color">
